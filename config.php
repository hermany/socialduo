...
if (_TIPO_CONEXION == "localhost"){
  ...
  define('_PASSWORD','');
  define('_BASE_DE_DATOS','socialduo_1');
  

  define('_RUTA_SERVER',str_replace("","",$_SERVER['DOCUMENT_ROOT'])."/server/");
  define('_RUTA_NUCLEO',_RUTA_SERVER."nucleo/");
  define('_RUTA_HOST',_RUTA_SERVER."socialduo/");

  define('_RUTA_WEB',"http://localhost/server/socialduo/");
...
if (_TIPO_CONEXION == "online"){
  ...
  define('_BASE_DE_DATOS','hermanyu_socialduo_1');
  

  define('_RUTA_SERVER',str_replace("","",$_SERVER['DOCUMENT_ROOT'])."/server/");
  define('_RUTA_NUCLEO',_RUTA_SERVER."nucleo/");
  define('_RUTA_HOST',_RUTA_SERVER."zundi/");

  define('_RUTA_WEB',"http://socialduo.in/");
